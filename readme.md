...
If you get a <b>'File' has no member named 'dirEntry'</b> error, then a modification is needed on the SdFat Library SdFatConfig.h file (line 120 as of version 2.2.3) changing:<br>
